...
mv.price_soldier(5)   # 5명이서 군인 할인 영화보러 갔을 때 가격
'''
...
price(3)           # 3명이서 영화보러 갔을 때 가격
price_morning(4)   # 4명이서 조조 할인 영화보러 갔을 때 가격
price_soldier(5)   # 5명이서 군인 할인 영화보러 갔을 때 가격
'''


from theater_module import price_soldier as price

price(5)           # 5명이서 군인 할인 영화보러 갔을 때 가격